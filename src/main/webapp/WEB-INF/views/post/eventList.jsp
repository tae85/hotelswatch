  ...
  <div id="wrap">
    ...
    <main id="container" class="all_event_page sub_container">
      <div class="sub_tit_wrap">
        <h2 class="tit">호텔스와치 이벤트</h2>
      </div>
      <div class="content">
        <div class="inner">
          <ul class="event_list">
            <li class="list_tit">전체 프로모션</li>
		<c:choose>
			...
			<c:otherwise>
				<c:forEach items="${ eventLists }" var="row" varStatus="loop">
					<li class="event_box">
		              <a href="./postView.do?post_idx=${ row.post_idx }&type=e" class="left">
